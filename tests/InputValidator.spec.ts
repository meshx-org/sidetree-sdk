    ...
    describe("validateEs256kOperationKey", () => {
        it("should throw if given private key does not have d", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEs256kHasIncorrectLengthOfD: SECP256K1 JWK 'd' property must be 43 bytes.`
                )
            }
        })
        ...
        it("should throw if given key does not have crv", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEs256kMissingOrInvalidCrv: SECP256K1 JWK 'crv' property must be 'secp256k1' but got 'undefined.'`
                )
            }
        })
        ...
        it("should throw if given key does not have kty", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEs256kMissingOrInvalidKty: SECP256K1 JWK 'kty' property must be 'EC' but got 'undefined.'`
                )
            }
        })
        ...
        it("should throw if given key has extra properties", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `PublicKeyJwkEs256kHasUnexpectedProperty: SECP256K1 JWK key has unexpected property 'extra'.`
                )
            }
        })
        ...
        it("should throw if given key x value is not the correct length", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEs256kHasIncorrectLengthOfX: SECP256K1 JWK 'x' property must be 43 bytes.`
                )
            }
        })
    ...
    describe("validateEd25519OperationKey", () => {
        ...
        it("should throw if given key does not have crv", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEd25519MissingOrInvalidCrv: Ed25519 JWK 'crv' property must be 'Ed25519' but got 'undefined.'`
                )
            }
        })
        ...
        it("should throw if given key does not have kty", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `JwkEd25519MissingOrInvalidKty: Ed25519 JWK 'kty' property must be 'OKP' but got 'undefined.'`
                )
            }
        })
        ...
        it("should throw if given key has extra properties", () => {
            ...
            try {
                ...
                expect(e.message).toEqual(
                    `PublicKeyJwkEd25519HasUnexpectedProperty: Ed25519 JWK key has unexpected property 'extra'.`
                )
            }
        })
